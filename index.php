...
if($currentStatus1 == "1") print "<a href ='index.php?status1=0'><font size = 8 color = green><b>inschakelen</b></font></a>";
else print "<a href = 'index.php?status1=1'><font size = 8 color = red><b>uitschakelen</b></font></a>";
...
if($currentStatus2 == "1") print "<a href ='index.php?status2=0'><font size = 8 color = green><b>aan</b></font></a>";
else print "<a href = 'index.php?status2=1'><font size = 8 color = red><b>uit</b></font></a>";
...
print "<br> <font size = 8 color = black><b>Klik hier om te schakelen : </font>";
if($currentStatus3 == "1") print "<a href ='index.php?status3=0'><font size = 8 color = green><b>Relais 3 ON</b></font></a>";
else print "<a href = 'index.php?status3=1'><font size = 8 color = red><b>Relais 3 OFF</b></font></a>";
